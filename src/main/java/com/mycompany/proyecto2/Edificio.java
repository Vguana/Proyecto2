public class Edificio implements ImpactoEcologico {
    ...
    public Edificio(double estrategiasReduccionEmisiones, double impactoTransporteLogistica,
            double adaptabilidad, double usoEnergiasRenovables, double sistemasGestionEnergia) {
    ...
    public double calcularImpactoEcologico() {
        return estrategiasReduccionEmisiones + impactoTransporteLogistica 
                + adaptabilidad - usoEnergiasRenovables - sistemasGestionEnergia;
    }
