public class Bicicleta implements ImpactoEcologico {
    ...
    public Bicicleta(double estrategiasReduccionEmisiones, double impactoTransporteLogistica, double adaptabilidad, double disenoAerodinamicoPeso) {
    ...
    public double calcularImpactoEcologico() {
        return estrategiasReduccionEmisiones + impactoTransporteLogistica + adaptabilidad - disenoAerodinamicoPeso;
    }
